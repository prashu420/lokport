...
const contactInfo = [
  ...
  {
    type: 'Email',
    value: 'Lokesh143kumawat143@gmail.com',
    href: 'mailto:Lokesh143kumawat143@gmail.com',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function ContactSection() {
  return (
    <AnimatedSection id="contact" className="bg-gray-100/30 dark:bg-gray-800/30">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {contactInfo.map((contact, index) => (
            <motion.a
              ...
              whileHover="hover"
              viewport={{ once: true }}
              className="card group flex items-center space-x-4 hover:border-blue-600/50 dark:hover:border-blue-500/50 transition-colors"
            >
              <motion.span 
